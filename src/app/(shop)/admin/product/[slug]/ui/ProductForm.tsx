...

            {
              sizes.map(size => (
                ...
                <div
                  ...
                  className={
                    clsx(
                      "p-2 cursor-pointer border rounded-md mr-2 mb- 2 w-14 transation-all text-center", {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {
              product.ProductImage?.map(image => (
                <div key={image.id}>
                  ...
                  <button onClick={() => deleteProductImage(image.id, image.url)} type="button" className="btn-danger w-full rounded-b-xl">
                    Eliminar
                  </button>
                </div>
              ))
